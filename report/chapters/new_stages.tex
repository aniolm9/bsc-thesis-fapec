...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[scale=0.5]{images/Rick Astley - Never Gonna Give You Up.wav_hist.pdf}
		\caption{Histogram of an audio file.}
		\label{fig:hist_example}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[scale=0.5]{images/Rick Astley - Never Gonna Give You Up.wav_hist_cum.pdf}
