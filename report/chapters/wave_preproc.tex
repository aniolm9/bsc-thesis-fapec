...
To conclude this section, we shall provide a justification on why we can use both \acrshort{iq} and audio files to test \textit{Wave} and why we can compare it with the \acrshort{flac} standard.
