...
Besides the requirements and specifications from section \ref{sec:fapec_reqs}, \textit{Wave} must also fulfill:
\begin{enumerate}
...
\end{tabular}
\caption{Euclidean distances for Figure \ref{fig:audio_compare}.}
