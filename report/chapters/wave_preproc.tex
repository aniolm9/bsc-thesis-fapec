...
\begin{figure}[h!]
	\begin{center}
		\scalebox{.71}{\input{images/wave_flowchart.tex}}
	\end{center}
...
As we can see in table \ref{tab:negentropies}, negentropy of all files improves after applying the stage we have developed.
