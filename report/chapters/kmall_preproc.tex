...
In conclusion, we will design a stage which will only give some special attention to the information contained in the \textit{BeamData} subdatagram from \acrshort{mwc} datagrams.
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=0.32]{images/water_column_amp.png}
	\end{center}
