...
\begin{comment}
Explicar les estructures de dades del KMALL i KMWCD basant-me en el dOxygen de Kongsberg.
\end{comment}
...
\begin{comment}
Incloure taula com la del dOxygen, però potser resumida i cito la resta.
\end{comment}
